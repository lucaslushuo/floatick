<div align="center">
  ...
  />
  <h1>Floatick</h1>
  <p><strong>一款克制、仅存本地的 macOS 悬浮待办应用。</strong></p>
  <p>
    让待办始终触手可及，同时保留干净的桌面与属于你的数据。
  </p>
  <p>
...
Floatick 平时以一个小巧、可拖动的图标悬浮在工作区上方。点击图标会展开专注的
待办面板；收起后，图标会准确回到原来的锚点。面板还会根据图标附近的屏幕空间
自动选择展开方向，因此放在屏幕边缘也能自然使用。
